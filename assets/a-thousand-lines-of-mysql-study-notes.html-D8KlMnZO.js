import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as p,o as l,c as t,a as n,b as s,d as o,e as i}from"./app-Dl67cLp_.js";const c={},d={href:"https://shockerli.net/post/1000-line-mysql-note/",target:"_blank",rel:"noopener noreferrer"},r=i(`<p>非常不错的总结，强烈建议保存下来，需要的时候看一看。</p><h3 id="基本操作" tabindex="-1"><a class="header-anchor" href="#基本操作"><span>基本操作</span></a></h3><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token comment">/* Windows服务 */</span>
...
c<span class="token punctuation">.</span> <span class="token keyword">WHERE</span> 子句
    ...
    <span class="token comment">-- 表达式由运算符和运算数组成。</span>
        ...
        <span class="token comment">-- 运算符：</span>
            ...
            <span class="token operator">is</span><span class="token operator">/</span><span class="token operator">is</span> <span class="token operator">not</span> 加上<span class="token boolean">true</span><span class="token operator">/</span><span class="token boolean">false</span><span class="token operator">/</span>unknown，检验某个值的真假
